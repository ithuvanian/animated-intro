...
$(document).ready(function () {
  $('.frame2, .frame3, .frame1 > p, .dots').hide();
  $('.overlay').fadeOut();
  ...
  $('.frame2 > p, .block').on('click', function () {
    $('body').css('background', frame3color);
    $('.circle').hide();
  ...
  // frame3 content depends on which frame2 item is clicked 
